...
player_left_image=pygame.transform.scale(pygame.image.load('playerL.png'),player_resize)
player_right_image=pygame.transform.scale(pygame.image.load('playerR.png'),player_resize)
